...
/*	public static final int COLOR_TYPE_UNKNOWN = -1;
	...
	public static void main(String[] args) {
		ImageProp imageInfo = new ImageProp();
	...
	private static void print(String sourceName, ImageProp ii, boolean verbose) {
		if (verbose) {
	...
	private static void printCompact(String sourceName, ImageProp imageInfo) {
		final String SEP = "\t";
		System.out.println(
			sourceName + SEP + 
	...
	private static void printVerbose(String sourceName, ImageProp ii) {
	...
	private static void run(String sourceName, InputStream in, ImageProp imageInfo, boolean verbose) {
